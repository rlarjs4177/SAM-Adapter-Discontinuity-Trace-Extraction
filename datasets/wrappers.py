...
class ValDataset(Dataset):
    def __init__(self, dataset, inp_size=None, augment=False):
        ...
        self.mask_transform = transforms.Compose([
                transforms.Resize((inp_size, inp_size), interpolation=Image.BICUBIC, antialias=True),
                transforms.ToTensor(),
            ])
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask = transforms.Resize((self.inp_size, self.inp_size), interpolation=InterpolationMode.BICUBIC, antialias=True)(mask)
